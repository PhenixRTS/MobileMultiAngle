...
final class Bootstrap {
        ...
        queue.sync(flags: [.barrier]) {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    let viewController = self.makeStreamListViewController(
                        core: core,
                        session: session,
    ...
    private func makeStreamListViewController(
        core: PhenixCore,
        session: AppSession,
        ...
        let viewModel = StreamViewController.ViewModel(core: core, session: session, closedCaptions: closedCaptions)
