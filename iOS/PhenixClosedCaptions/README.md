...
![Your project root folder containing the PhenixClosedCaptions](./docs/resources/image1.png)
...
5. In the file chooser, navigate to the `PhenixClosedCaptions` and select `PhenixClosedCaptions.xcodeproj`.
Then click *Add* to add it as a sub-project.

![PhenixClosedCaptions Xcode project file selected](./docs/resources/image3.png)
...
8. Click on the + button to select and add a new framework.
...
![Search for PhenixClosedCaptions framework](./docs/resources/image6.png)
