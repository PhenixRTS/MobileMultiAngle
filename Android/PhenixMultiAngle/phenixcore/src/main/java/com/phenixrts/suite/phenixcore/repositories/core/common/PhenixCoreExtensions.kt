...
internal fun getCreateRoomOptions(configuration: PhenixRoomConfiguration): RoomOptions = RoomServiceFactory.createRoomOptionsBuilder()
    .withAlias(configuration.roomAlias)
    .withName(configuration.roomAlias)
